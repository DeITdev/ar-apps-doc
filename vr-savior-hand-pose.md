...
4. [Step-by-Step Setup Guide](#step-by-step-setup-guide)
   ...
   - [Step 3: Save the Pose](#step-3-save-the-pose)
   - [Step 4: Mirror the Pose](#step-4-mirror-the-pose)
   - [Step 5: Create Animation Clips](#step-5-create-animation-clips)
...
The hand pose system enables per-object custom hand animations in VR. When a player grabs an object, the hand model transitions from its default resting pose to a specific grasp pose that matches the shape of the object (e.g., gripping a wrench, holding a carabiner, pinching a small item).
